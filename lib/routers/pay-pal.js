...
router.post('/orders', async (req, res) => {
    ...
    const config = {
        headers: {
            ...
            'PayPal-Auth-Assertion':'eyJhbGciOiJub25lIn0=.eyJpc3MiOiJBWkhMdVdtRWNhOE5JZHZYWlF1UUxLZE9pOVg3NEhlSjdxamRQa3d4bFJFekVWX2pkMjNOQ2p3VEFWNEUxaWNTU0Vpc3hjLVlub3JTVEtMMSIsInBheWVyX2lkIjoiSkFNUTI3Wko5MzRSTiJ9.'
        }
    };
    try {
   ...
   //console.log("Suresh"+"entering processOrder1 body "+req.body.toJSON()+ "req.params.order_id"+req.params.order_id);
    ...
    const config = {
        headers: {
            ...
            'PayPal-Partner-AttributionId':'USNATIVE_SB',
            'PayPal-Auth-Assertion':'eyJhbGciOiJub25lIn0=.eyJpc3MiOiJBWkhMdVdtRWNhOE5JZHZYWlF1UUxLZE9pOVg3NEhlSjdxamRQa3d4bFJFekVWX2pkMjNOQ2p3VEFWNEUxaWNTU0Vpc3hjLVlub3JTVEtMMSIsInBheWVyX2lkIjoiSkFNUTI3Wko5MzRSTiJ9.'
