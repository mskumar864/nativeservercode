...
router.post('/orders', async (req, res) => {
    ...
    const config = {
        headers: {
           ...
           'PayPal-Auth-Assertion':'eyJhbGciOiJub25lIn0=.eyJpc3MiOiJBUk5ZYXFvNV84TXpHUzBBMzdMRTJvZDg5Qjc3amZMTzkyb2o3dTBDVXR1enVyZVp0THB1dDktZDBpb21JWGVCeGZOSkVVY1BZTlFOOGtBOSIsInBheWVyX2lkIjoiUkU4WEtEQjc2TkNITCJ9.',
